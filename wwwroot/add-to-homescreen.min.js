(() => {
    ...
    class e {
        ...
        show() {
            ...
            });
            {
                ...
                n.classList.add("adhs-container"), n.style.height = document.body.clientHeight + "px", n.style.width = window.innerWidth + "px", this.isDeviceIOS() ? this.isBrowserIOSSafari() ? (s = new e.ReturnObj({
                    ...
                    canBeStandAlone: !1,
                    device: ""
                }), this.showErrorMessageForUnsupportedBrowsers & e.SHOW_ERRMSG_UNSUPPORTED.DESKTOP ? this._genErrorMessage(n, "Por favor abra o site em um telefone.", "Atualmente, a instalação na tela inicial é compatível apenas com IOS e Android.") : t = !1), t && (document.body.appendChild(n), this._registerCloseListener(), setTimeout((() => {
        ...
        _genTitle() {
            return this._genTitleWithMessage("Instale o " + this.appName + " aplicativo para continuar")
        }
        _genModalStart() {
        ...
        static copyToClipboard() {
            ...
            try {
                window.navigator.clipboard.writeText(e), document.getElementsByClassName("adhs-error-copy-link-button")[0].innerHTML = "Link copiado para a área de transferência!"
            } catch (e) {
